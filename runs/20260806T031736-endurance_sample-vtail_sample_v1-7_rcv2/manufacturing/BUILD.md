# Build document — vtail_sample_v1.7_rcv2 / endurance_sample

From the `2026-08-06T03:17:36` run. Every dimension here is read off the
...
- **CG target:** **498.2 mm** aft of the nose datum
- **Allowable CG range:** 477.4 mm (forward, 15% margin) to 494.1 mm (aft, 8% margin) — a **17 mm** window
- **Neutral point:** 513.3 mm; reference chord 239.0 mm
- **As-designed static margin:** 0.0629
- **WARNING — the CG target is 4.1 mm aft of the aft limit** derived just above. The design does not meet the stability window it was optimized against; treat the margin as unverified until an external check (flow5 or equivalent) settles it.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| wing | sd7037 | 2,000 | 0.4781 | 275 | 137 | 5 | True |
| vtail | naca0009 | 475 | 0.04337 | 91.9 | 90.7 | 2 | True |
...
- **ruddervator** on `vtail`, station 0→1: hinge at **60% chord**, length 237.5 mm, control chord 36.8 → 36.3 mm (mirrored pair)
...
Target all-up weight **2119 g**.

| component | mass (g) | station (mm) | share |
| --- | --- | --- | --- |
| printed_wing | 655.5 | 498 | 30.9% |
| battery | 460.0 | 330 | 21.7% |
| pod | 213.8 | 460 | 10.1% |
| motor | 170.0 | 232 | 8.0% |
| wing_spars_joiners | 113.8 | 472 | 5.4% |
| printed_vtail | 82.8 | 1580 | 3.9% |
| esc | 75.0 | 435 | 3.5% |
| propeller | 55.5 | 188 | 2.6% |
| boom | 47.4 | 1123 | 2.2% |
| flight_controller | 40.0 | 523 | 1.9% |
| telemetry_sik | 30.0 | 431 | 1.4% |
| wiring_pod | 24.0 | 430 | 1.1% |
| gps_compass | 22.0 | 531 | 1.0% |
| companion_pi | 20.0 | 437 | 0.9% |
| wiring_boom | 16.0 | 1123 | 0.8% |
| servo_aileron_left | 14.0 | 570 | 0.7% |
| servo_aileron_right | 14.0 | 570 | 0.7% |
| servo_ruddervator_left | 14.0 | 1521 | 0.7% |
| servo_ruddervator_right | 14.0 | 1521 | 0.7% |
| bec_pi | 12.0 | 483 | 0.6% |
| pitot_probe | 9.0 | 390 | 0.4% |
| airspeed_board | 6.0 | 589 | 0.3% |
| receiver_elrs | 5.0 | 564 | 0.2% |
| buzzer | 3.0 | 550 | 0.1% |
| sd_card_fc | 1.0 | 523 | 0.0% |
| sd_card_pi | 1.0 | 437 | 0.0% |
| nose_ballast | 0.0 | 198 | 0.0% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| centre carry-through | 1 | 10 | 1 | 8 | 350 | 15.8 | 19.83 | 342.1 | 200 | -41.5 | 25.4 | 17.5 | -31.1 | 700 |
| outer panel | 2 | 8 | 1 | 6 | 467.5 | 16.4 | 6.86 | 199.6 | 200 | 0.2 | 33.1 | 23.4 | -29.3 | 467.5 |

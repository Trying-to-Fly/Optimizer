# Build document — vtail_sample_v1.7 / endurance_sample

From the `2026-08-05T00:07:21` run. Every dimension here is read off the
...
- **CG target:** **500.9 mm** aft of the nose datum
- **Allowable CG range:** 486.7 mm (forward, 15% margin) to 500.9 mm (aft, 8% margin) — a **14 mm** window
- **Neutral point:** 517.1 mm; reference chord 202.8 mm
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| wing | sd7037 | 2,000 | 0.4056 | 251 | 140 | 5 | True |
| vtail | naca0009 | 422 | 0.03938 | 93.9 | 92.7 | 2 | True |
...
- **ruddervator** on `vtail`, station 0→1: hinge at **60% chord**, length 211.0 mm, control chord 37.6 → 37.1 mm (mirrored pair)

# Build document — vtail_sample_v1.6_chord275 / endurance_sample

From the `2026-07-31T15:22:08` run. Every dimension here is read off the
...
- **CG target:** **501.0 mm** aft of the nose datum
- **Allowable CG range:** 486.8 mm (forward, 15% margin) to 501.0 mm (aft, 8% margin) — a **14 mm** window
- **Neutral point:** 517.2 mm; reference chord 202.8 mm
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| wing | sd7037 | 2,000 | 0.4056 | 251.1 | 140 | 5 | True |
| vtail | naca0009 | 421.5 | 0.03933 | 93.6 | 93 | 2 | True |
...
- **ruddervator** on `vtail`, station 0→1: hinge at **60% chord**, length 210.8 mm, control chord 37.4 → 37.2 mm (mirrored pair)
...
Target all-up weight **1788 g**.

| component | mass (g) | share |
| --- | --- | --- |
| printed_wing | 546.1 | 30.5% |
| battery | 430.0 | 24.0% |
| motor_prop | 200.5 | 11.2% |
| pod | 150.4 | 8.4% |
| wing_spars_joiners | 101.5 | 5.7% |
| esc_wiring | 80.0 | 4.5% |
| printed_vtail | 77.8 | 4.4% |
| fc_gps_rx | 60.0 | 3.4% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| centre carry-through | 1 | 10 | 1 | 8 | 350 | 15.8 | 16.73 | 288.7 | 200 | -30.7 | 21.4 | 17.5 | -18.4 | 700 |
| outer panel | 2 | 8 | 1 | 6 | 467.5 | 16.4 | 5.79 | 168.5 | 200 | 18.7 | 27.9 | 23.4 | -16.2 | 467.5 |

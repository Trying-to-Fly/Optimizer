...
From the `2026-07-27T07:57:40` run. Every dimension here is read off the
...
- **CG limits: not available.** This run predates the static-margin
...
| winglet | sd7037 | 240 | 0.02284 | 112 | 78.4 | 2 | True |
...
Every 100 g over target costs about **7.8 min**.

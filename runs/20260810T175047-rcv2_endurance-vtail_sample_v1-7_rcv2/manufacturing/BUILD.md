...
From the `2026-08-10T17:50:47` run. Every dimension here is read off the
...
- **CG target:** **497.1 mm** aft of the nose datum
- **Allowable CG range:** 476.8 mm (forward, 15% margin) to 493.9 mm (aft, 8% margin) — a **17 mm** window
- **Neutral point:** 513.3 mm; reference chord 243.1 mm
- **As-designed static margin:** 0.0665
- **WARNING — the CG target is 3.3 mm aft of the aft limit** derived just above. The design does not meet the stability window it was optimized against. Nothing outside this app checks that margin — weigh, balance and fly conservatively rather than treating the number as verified.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| wing | sd7037 | 2,000 | 0.4863 | 275 | 137.3 | 5 | True |
| vtail | naca0009 | 465 | 0.04257 | 91.8 | 91.3 | 2 | True |
| winglet | sd7037 | 156.6 | 0.01434 | 91.6 | 91.6 | 2 | True |
...
- **ruddervator** on `vtail`, station 0→1: hinge at **60% chord**, length 232.5 mm, control chord 36.7 → 36.5 mm (mirrored pair)
...
Target all-up weight **2173 g**.

| component | mass (g) | station (mm) | share |
| --- | --- | --- | --- |
| printed_wing | 668.5 | 499 | 30.8% |
| battery | 460.0 | 324 | 21.2% |
| pod | 213.8 | 453 | 9.8% |
| motor | 170.0 | 226 | 7.8% |
| wing_spars_joiners | 111.7 | 472 | 5.1% |
| printed_vtail | 81.8 | 1588 | 3.8% |
| esc | 75.0 | 428 | 3.5% |
| propeller | 55.5 | 182 | 2.6% |
| boom | 48.3 | 1125 | 2.2% |
| flight_controller | 40.0 | 517 | 1.8% |
| telemetry_sik | 30.0 | 425 | 1.4% |
| printed_winglet | 27.4 | 615 | 1.3% |
| wiring_pod | 24.0 | 424 | 1.1% |
| gps_compass | 22.0 | 525 | 1.0% |
| companion_pi | 20.0 | 431 | 0.9% |
| wiring_boom | 16.0 | 1125 | 0.7% |
| winglet_joiners | 16.0 | 472 | 0.7% |
| servo_aileron_left | 14.0 | 568 | 0.6% |
| servo_aileron_right | 14.0 | 568 | 0.6% |
| servo_ruddervator_left | 14.0 | 1531 | 0.6% |
| servo_ruddervator_right | 14.0 | 1531 | 0.6% |
| bec_pi | 12.0 | 477 | 0.6% |
| pitot_probe | 9.0 | 384 | 0.4% |
| airspeed_board | 6.0 | 583 | 0.3% |
| receiver_elrs | 5.0 | 558 | 0.2% |
| buzzer | 3.0 | 544 | 0.1% |
| sd_card_fc | 1.0 | 517 | 0.0% |
| sd_card_pi | 1.0 | 431 | 0.0% |
| nose_ballast | 0.0 | 192 | 0.0% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| centre carry-through | 1 | 10 | 1 | 8 | 350 | 15.8 | 20.34 | 350.9 | 200 | -43 | 26 | 17.5 | -32.8 | 700 |
| outer panel | 2 | 8 | 1 | 6 | 467.5 | 16.4 | 7.04 | 204.8 | 200 | -2.3 | 33.9 | 23.4 | -31.1 | 467.5 |

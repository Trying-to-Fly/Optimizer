...
Generated from `2026-07-23T18:13:36` run artifacts. Numbers below are the
model's optimum and the constraints that bound it — design around them,
and use the prices to judge deviations.

**Champion:** 114.1 min at V = 9.5 m/s, AUW 1.820 kg, static margin 0.080.

**Mass price:** 7.70 min per 100 g added anywhere on the aircraft (from the champion re-solve). Any wetted-area
...
- **equipment bay (constant section):** 310 mm
- **boat-tail (floor 1.8 x d_eq):** 111 mm (floor 111 mm)
- **overall pod:** 482 mm
- **fineness (L / d_eq):** 7.85

## Balance — battery must reach these stations

- **bay interior spans:** 100 mm to 410 mm aft of nose datum
- **battery CG window (3 mm end margins):** 168 mm to 342 mm
- **champion battery CG:** 168 mm

## Fixed interfaces

- **wing saddle (bay aft end, datum anchor):** 410 mm
- **pod centerline below wing datum:** 30 mm
- **boom socket at tail cap (pod-boom topology):** 12 mm OD at station 521 mm
- **tail block station (champion tail arm):** 959 mm
- **ESC / FC+GPS stack lengths:** 55 mm / 60 mm

## Deviation prices (mass route only — drag adds on top)

- **+0.01 m2 wetted area:** 1.13 objective units
- **+100 g anywhere:** 7.70 objective units
